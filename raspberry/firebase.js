...
module.exports = function () {
     ...
     * with the error as parameter.
     */
    this.getAllZones = function (successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.listeningAllZones = function (successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getSensor = function (zoneName, sensorName, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getAllSensors = function (zoneName, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.updateZoneChilds = function (zoneName, object, successCallback, failureCallback) {
        // successCallback is optional
        successCallback = (typeof (successCallback) !== "function") ? function (value) {
            return value
        } : successCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getZoneChild = function (zoneName, key, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
    ...
    this.getName = function (zoneName, successCallback, failureCallback) {
        getZoneChild(zoneName, "name", successCallback, failureCallback);
    }

    this.getCurrent = function (zoneName, successCallback, failureCallback) {
        getZoneChild(zoneName, "current", successCallback, failureCallback);
    }

    this.updateCurrent = function (zoneName, value, successCallback, failureCallback) {
        updateZoneChild(zoneName, "current", value, successCallback, failureCallback);
    }

    this.getMax = function (zoneName, successCallback, failureCallback) {
        getZoneChild(zoneName, "max", successCallback, failureCallback);
    }

    this.updateMax = function (zoneName, value, successCallback, failureCallback) {
        updateZoneChild(zoneName, "max", value, successCallback, failureCallback);
    }

    this.getEnabled = function (zoneName, successCallback, failureCallback) {
        getZoneChild(zoneName, "enabled", successCallback, failureCallback);
    }

    this.updateEnabled = function (zoneName, value, successCallback, failureCallback) {
        updateZoneChild(zoneName, "enabled", value, successCallback, failureCallback);
    }

    this.listeningEnabled = function (zoneName, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getPeriodicitySensor = function (zoneName, sensorName, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getLastValues = function (zoneName, sensorName, nLastValues, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getFirstValues = function (zoneName, sensorName, nFirstValues, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getRangeValuesTimestamp = function (zoneName, sensorName, startTimestamp, endTimestamp, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
     ...
     * @param failureCallback The failure callback.
     */
    this.getSensorLastUpdate = function (zoneName, sensorName, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
    ...
    this.incrementCurrent = function (zoneName, N, successCallback, failureCallback) {
        // failureCallback is optional
        failureCallback = (typeof (failureCallback) !== "function") ? function (error) {
            return error
        } : failureCallback;
